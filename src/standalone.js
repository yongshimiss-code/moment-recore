const books = [
  {
    ...
    coverImage: "https://covers.openlibrary.org/b/olid/OL26414386M-L.jpg?default=false",
  ...
  },
  {
    ...
    coverImage: "https://covers.openlibrary.org/b/olid/OL30515574M-L.jpg?default=false",
    heroImage: "assets/cat-hd-read.png",
    detailImage: "assets/cat-hd-read.png"
  },
  {
    ...
    coverImage: "https://covers.openlibrary.org/b/olid/OL25430491M-L.jpg?default=false",
    heroImage: "assets/cat-hd-read.png",
    detailImage: "assets/cat-hd-read.png"
  },
  {
    ...
    coverImage: "https://covers.openlibrary.org/b/olid/OL26314691M-L.jpg?default=false",
    heroImage: "assets/cat-hd-read.png",
    detailImage: "assets/cat-hd-read.png"
  }
];
...
const imageAssets = {
  ...
  callGray: "assets/cat-hd-sit.png",
  callOrange: "assets/cat-hd-heart.png"
};
...
function createBookCover(book, compact = false) {
  return `
    <div class="book-cover book-cover--image${compact ? " book-cover--compact" : ""}">
      <img class="book-cover__image" src="${book.coverImage}" alt="${book.title} cover" loading="eager" decoding="sync" draggable="false">
    </div>
  `;
}
...
function updateBooksDragTargetFromPoint(clientX, clientY) {
  ...
  const groupBlock = target?.closest?.("[data-group-name]");
...
function syncDraggingBookVisual(clientX, clientY) {
  ...
  const activeRow = document.querySelector(`[data-book-row][data-book="${state.draggingBookId}"]`);
  if (!activeRow) {
    return;
  }
...
function endHomeNotesDrag() {
  ...
  if (homeNotesDragging) {
    snapHomeNotesScroller(activeHomeNotesScroller);
  }
